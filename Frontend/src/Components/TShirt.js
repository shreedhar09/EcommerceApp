...
import { getProductTShirtAction } from "../Redux/AuthAction";

export class TShirt extends Component {
  async componentDidMount() {
    await this.props.getProductTShirtAction("Clothing", "TShirt");
  }
  render() {
    debugger
...
const mapStateToProps = state => {
  return { particularProductData: state.ProductTShirt.productDataSpecific };
};
export default connect(mapStateToProps, { getProductTShirtAction })(TShirt);
